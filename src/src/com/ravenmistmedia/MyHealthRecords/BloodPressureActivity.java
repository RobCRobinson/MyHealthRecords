...
public class BloodPressureActivity extends Activity {
	...
	protected void onResume() {
		...
		try {
		LinearLayout l = (LinearLayout) findViewById( R.id.LayoutBloodPressure );  
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		switch (item.getItemId()) {
	        ...
	        case R.id.emailRecords:
	        	...
	        	String rowData = "";
	        	try {
	        		rowData = db.exportTableString(db.DATABASE_TABLE_BPPULSES, "Blood Pressure and Pulse Records");
	        	} catch (IOException e) {
	        ...
	        case R.id.textMessageRecords:
	        	...
	        	String rowData2 = "";
	        	try {
	        		rowData2 = db.exportTableString(db.DATABASE_TABLE_BPPULSES, "Blood Pressure and Pulse Records");
	        	} catch (IOException e) {
	        ...
	        case R.id.copyClipboard:
	        	...
	        	String rowData3 = "";
	        	try {
	        		rowData3 = db.exportTableString(db.DATABASE_TABLE_BPPULSES, "Blood Pressure and Pulse Records");
	        	} catch (IOException e) {
	        	...
	        	builder.setSingleChoiceItems(list2, selIndex, new DialogInterface.OnClickListener() {
	        		public void onClick(DialogInterface dialog, int item) {
	        			...
	        			if (item > 0){
		        	    	...
		        	    	final Dialog dialog1 = new Dialog(BloodPressureActivity.this);
    ...
    public void newRecord(View v){
    	final DBAdapter db = new DBAdapter(this);
    	final Dialog dialog = new Dialog(BloodPressureActivity.this);
    	final AlertDialog ad = new AlertDialog.Builder(BloodPressureActivity.this).create();
    	
    	dialog.setContentView(R.layout.bloodpressureinput);
    	dialog.setTitle(getResources().getString(R.string.inputTitle));
    	dialog.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE);
    	
    	RelativeLayout l = (RelativeLayout) dialog.findViewById( R.id.LayoutBloodPressureInput );
    	if(s.equals("")|| s.equals("Blue")){
        	l.setBackgroundResource(R.drawable.backrepeat);
        } else if (s.equals("Lavender")){
        	l.setBackgroundResource(R.drawable.backrepeat2);
    	...
    	final EditText dialogtxtSystolic = (EditText) dialog.findViewById(R.id.edtInputSystolic);
    	final EditText dialogtxtDiastolic = (EditText) dialog.findViewById(R.id.edtInputDiastolic);
    	final EditText dialogtxtPulse = (EditText) dialog.findViewById(R.id.edtInputPulse);
    	final EditText dialogtxtNotes = (EditText) dialog.findViewById(R.id.edtBloodPressureNotes);
    	final EditText dialogtxtRecDate = (EditText) dialog.findViewById(R.id.edtBPPulseInputRecDate);
    	
    	dialogmDelete = (Button) dialog.findViewById(R.id.btnDeleteBPPulse);
    	dialogmSave = (Button) dialog.findViewById(R.id.btnSaveBPPulse);
    	
    	EditText txtRecDate = (EditText) dialog.findViewById(R.id.edtBPPulseInputRecDate);
    	...
    	dialogmSave.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
            	String sSystolic = dialogtxtSystolic.getText().toString();
            	String sDiastolic = dialogtxtDiastolic.getText().toString();
            	String sPulse = dialogtxtPulse.getText().toString();
            	...
            	int iPulse = 0;
            	try {
            		iSystolic = Integer.parseInt(sSystolic);
            	} catch (Exception ex){}
            	try {
            		iDiastolic = Integer.parseInt(sDiastolic);
            	} catch (Exception ex){}
                try {
                	iPulse= Integer.parseInt(sPulse);
                } catch (Exception ex){}
        		...
        		try {
					...
					l = db.insertBPPulse(iSystolic,iDiastolic, iPulse, sNotes, lRecDate,personid);
					if (l != -1){
						dialog.dismiss();
					}else {
						dialog.dismiss();
    ...
    public void DisplayRecords(){
        ...
        String[] columntitles = getResources().getStringArray(R.array.bloodpressure_array);
        ...
        if (rowfilter.length() > 0){
        	c = db.getBPPulseRecordsByPersonIdAndKeyword(personid,rowfilter);
        }else {
        	c = db.getBPPulseRecordsByPersonId(personid);
        }
        ...
        if (c.moveToFirst())
        {
            do {
            	...
            	tr.addView(common.ColumnTV(this,sSystolic + "/" + sDiastolic));
            	tr.addView(common.ColumnTV(this,sPulse));
                ...
                tr.setOnClickListener(new  OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        try {
                        	...
                        	dialogtxtSystolic.setText(sSystolic);
                        	dialogtxtDiastolic.setText(sDiastolic);
                        	dialogtxtPulse.setText(sPulse);
                        	...
                        	dialogmDelete.setOnClickListener(new View.OnClickListener() {
                                public void onClick(View v) {
                                    boolean d = db.deleteBPPulseRecord(Long.parseLong(sId));
                                    if (d){
                                    	dialog.dismiss();
                                    }else {
                                    	dialog.dismiss();
                        	...
                        	dialogmSave.setOnClickListener(new View.OnClickListener() {
                                public void onClick(View v) {
                                    String sSys = dialogtxtSystolic.getText().toString();
                                    String sDias = dialogtxtDiastolic.getText().toString();
                                    String sPul = dialogtxtPulse.getText().toString();
                                    String sNot = dialogtxtNotes.getText().toString();
                                    String sRecDate = dialogtxtRecDate.getText().toString();
                                    
                                    int iSys = Integer.parseInt(sSys);
                                    int iDias = Integer.parseInt(sDias);
                                    int iPul = Integer.parseInt(sPul);
                            		...
                            		try {
	                                    ...
	                                    int personid = db.getCurrentPersonId();
	                                	boolean s = db.updateBPPulseRecord(Long.parseLong(sId),iSys,iDias,iPul,sNotes,lRd,personid);
	                                	if (s){
	                                    	dialog.dismiss();
	                                    }else {
	                                    	dialog.dismiss();
