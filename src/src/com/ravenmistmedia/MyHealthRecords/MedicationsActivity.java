...
public class MedicationsActivity extends Activity {
	...
	protected void onResume() {
		...
		try {
		LinearLayout l = (LinearLayout) findViewById( R.id.LayoutMedications );  
	...
	public boolean onOptionsItemSelected(MenuItem item) {
    	...
    	switch (item.getItemId()) {
	        ...
	        case R.id.emailRecords:
	        	...
	        	String rowData = "";
	        	try {
	        		rowData = db.exportTableString(db.DATABASE_TABLE_MEDICATIONS, "Medications");
	        	} catch (IOException e) {
	        ...
	        case R.id.textMessageRecords:
	        	...
	        	String rowData2 = "";
	        	try {
	        		rowData2 = db.exportTableString(db.DATABASE_TABLE_MEDICATIONS, "Medications");
	        	} catch (IOException e) {
	        ...
	        case R.id.copyClipboard:
	        	...
	        	String rowData3 = "";
	        	try {
	        		rowData3 = db.exportTableString(db.DATABASE_TABLE_MEDICATIONS, "Medications");
	        	} catch (IOException e) {
	        	...
	        	builder.setSingleChoiceItems(list2, selIndex, new DialogInterface.OnClickListener() {
	        		public void onClick(DialogInterface dialog, int item) {
	        			...
	        			if (item > 0){
		        	    	...
		        	    	final Dialog dialog1 = new Dialog(MedicationsActivity.this);
    ...
    public void newRecord(View v){
    	final DBAdapter db = new DBAdapter(this);
    	final Dialog dialog = new Dialog(MedicationsActivity.this);
    	final AlertDialog ad = new AlertDialog.Builder(MedicationsActivity.this).create();
    	
    	dialog.setContentView(R.layout.medicationsinput);
    	dialog.setTitle(getResources().getString(R.string.inputTitle));
    	dialog.getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_RESIZE);
    	LinearLayout l = (LinearLayout) dialog.findViewById( R.id.LayoutMedicationsInput );
    	if(s.equals("")|| s.equals("Blue")){
        	l.setBackgroundResource(R.drawable.backrepeat);
        } else if (s.equals("Lavender")){
        	l.setBackgroundResource(R.drawable.backrepeat2);
    	...
    	final EditText dialogtxtStartDate = (EditText) dialog.findViewById(R.id.edtInputMedStartDateDetail);
    	final EditText dialogtxtEndDate = (EditText) dialog.findViewById(R.id.edtInputMedEndDateDetail);
    	final EditText dialogtxtMedications = (EditText) dialog.findViewById(R.id.edtInputMedicationsDetail);
    	final EditText dialogtxtAdverse = (EditText) dialog.findViewById(R.id.edtInputAdverseDetail);
		...
		dialogtxtStartDate.setText(sNewDate);
		
    	dialogmDelete = (Button) dialog.findViewById(R.id.btnDeleteMedications);
    	dialogmSave = (Button) dialog.findViewById(R.id.btnSaveMedications);
    	
    	dialogmDelete.setVisibility(INVISIBLE);
    	
    	dialogmSave.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
            	String sStart = dialogtxtStartDate.getText().toString();
            	String sEnd = dialogtxtEndDate.getText().toString();
            	String sMed = dialogtxtMedications.getText().toString();
            	String sAdverse = dialogtxtAdverse.getText().toString();
            	
                db.open();
                int personid = db.getCurrentPersonId();
            	long l = db.insertMedications(sMed,sStart,sEnd,sAdverse,personid);
            	if (l != -1){
                	dialog.dismiss();
                }else {
                	dialog.dismiss();
    ...
    public void DisplayRecords(){
        ...
        String[] columntitles = getResources().getStringArray(R.array.medications_array);
        ...
        if (rowfilter.length() > 0){
        	c = db.getMedicationsByPersonIdAndKeyword(personid,rowfilter);
        }else {
        	c = db.getMedicationsByPersonId(personid);
        }
        ...
        if (c.moveToFirst())
        {
            do {
            	...
            	final String sMedications = c.getString(1);
            	final String sStartDate = c.getString(2);
            	final String sEndDate = c.getString(3);
            	final String sAdverse = c.getString(4);
            	...
            	tr.addView(common.ColumnTV(this,sStartDate));
            	tr.addView(common.ColumnTV(this,sEndDate));
            	tr.addView(common.ColumnTV(this,sMedications));
            	tr.addView(common.ColumnTV(this,sAdverse));
                ...
                tr.setOnClickListener(new  OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        try {
                        	...
                        	dialogtxtStartDate.setText(sStartDate);
                        	dialogtxtEndDate.setText(sEndDate);
                        	dialogtxtMedications.setText(sMedications);
                        	dialogtxtAdverse.setText(sAdverse);
                        	...
                        	dialogmDelete.setOnClickListener(new View.OnClickListener() {
                                public void onClick(View v) {
                                    boolean d = db.deleteMedications(Long.parseLong(sId));
                                    if (d){
                                    	dialog.dismiss();
                                    }else {
                                    	dialog.dismiss();
                        	...
                        	dialogmSave.setOnClickListener(new View.OnClickListener() {
                                public void onClick(View v) {
                                	...
                                	db.open();
                                    int personid = db.getCurrentPersonId();
                                	boolean s = db.updateMedications(Long.parseLong(sId),sMed,sStart,sEnd,sAdverse,personid);
                                	if (s){
                                    	dialog.dismiss();
                                    }else {
                                    	dialog.dismiss();
